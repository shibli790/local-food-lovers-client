...
export default function Footer() {
  return (
    <>
      <section className="bg-[#dd2386] text-white py-4 px-6 flex justify-between items-center  bottom-0 w-full">
        <footer className="footer sm:footer-horizontal container mx-auto text-white p-10 border-b-2 border-slate-400">
          ...
          <nav>
            <h6 className="font-bold px-3 font-bold py-1">Services</h6>
          ...
          <nav>
            <h6 className="font-bold px-3 font-bold py-1">Company</h6>
            <a className="px-3  hover:text-gray-300 font-semibold py-1">
              About us
            </a>
            <a className="px-3  hover:text-gray-300 font-semibold py-1">
          ...
          <nav>
            <h6 className="font-bold px-3 font-bold py-1">Legal</h6>
            <a className="px-3  hover:text-gray-300 font-semibold py-1">
              Terms of use
            </a>
            <a className="px-3  hover:text-gray-300 font-semibold py-1">
      ...
      <div className="flex flex-col justify-center items-center text-center gap-3 text-white p-10 bg-[#dd2386]">
        <aside>
          <svg
            width="50"
            height="50"
          ...
          <p className="font-bold text-white">
            Local Food Lovers Network
            <br />
            Providing Food Review since 2025
          </p>
        </aside>
        <nav>
